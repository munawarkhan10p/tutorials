...
intellisense.annotate(jQuery.fn, {
  ...
  'id': function() {
    /// <signature>
    ///   <summary>Selects a single element with the given movieID attribute.</summary>
    ///   <param name="movieID" type="String">An ID to search for, specified via the movieID attribute of an element.</param>
    /// </signature>
  },
  'image': function() {
